# Azure Pipelines - Security Hardening Guide
...
Security hardening for Azure Pipelines involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "Azure Pipelines Builder"
          },
          "buildType": "Azure Pipelines Pipeline",
          "invocation": {
            "configSource": {
...
maintain a robust security posture for your Azure Pipelines pipelines.
