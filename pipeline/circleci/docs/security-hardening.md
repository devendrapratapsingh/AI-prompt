# CircleCI - Security Hardening Guide
...
Security hardening for CircleCI involves implementing multiple layers of security controls
        ...
        "predicate": {
          ...
          "invocation": {
            "configSource": {
              ...
              "entryPoint": ".circleci/config.yml"
            }
          },
          "metadata": {
...
maintain a robust security posture for your CircleCI pipelines.

For additional security resources and updates, refer to:
- CircleCI Security Documentation
