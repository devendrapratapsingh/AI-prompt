# CloudBees CI - Security Hardening Guide
...
Security hardening for CloudBees CI involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "CloudBees CI Builder"
          },
          "buildType": "CloudBees CI Pipeline",
          "invocation": {
            "configSource": {
...
maintain a robust security posture for your CloudBees CI pipelines.

For additional security resources and updates, refer to:
- CloudBees CI Security Documentation
