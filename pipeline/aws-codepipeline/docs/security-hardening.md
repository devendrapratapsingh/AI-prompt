# AWS CodePipeline - Security Hardening Guide
...
Security hardening for AWS CodePipeline involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "AWS CodePipeline Builder"
          },
          "buildType": "AWS CodePipeline Pipeline",
          "invocation": {
            "configSource": {
...
maintain a robust security posture for your AWS CodePipeline pipelines.

For additional security resources and updates, refer to:
- AWS CodePipeline Security Documentation
