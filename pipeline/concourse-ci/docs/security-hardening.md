# Concourse CI - Security Hardening Guide
...
Security hardening for Concourse CI involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "Concourse CI Builder"
          },
          "buildType": "Concourse CI Pipeline",
          "invocation": {
            "configSource": {
...
maintain a robust security posture for your Concourse CI pipelines.

For additional security resources and updates, refer to:
- Concourse CI Security Documentation
