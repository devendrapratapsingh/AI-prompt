# Spinnaker - Security Hardening Guide
...
Security hardening for Spinnaker involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "Spinnaker Builder"
          },
          "buildType": "Spinnaker Pipeline",
          "invocation": {
            "configSource": {
              ...
              "entryPoint": "spinnaker-pipeline.json"
            }
          },
          "metadata": {
...
maintain a robust security posture for your Spinnaker pipelines.

For additional security resources and updates, refer to:
- Spinnaker Security Documentation
