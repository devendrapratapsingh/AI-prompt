# TeamCity - Security Hardening Guide
...
Security hardening for TeamCity involves implementing multiple layers of security controls
        ...
        "predicate": {
          ...
          "invocation": {
            "configSource": {
              ...
              "entryPoint": ".teamcity/settings.kts"
            }
          },
          "metadata": {
...
maintain a robust security posture for your TeamCity pipelines.

For additional security resources and updates, refer to:
- TeamCity Security Documentation
