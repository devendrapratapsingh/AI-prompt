# GitLab CI/CD - Security Hardening Guide
...
Security hardening for GitLab CI/CD involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "GitLab CI/CD Builder"
          },
          "buildType": "GitLab CI/CD Pipeline",
          "invocation": {
            "configSource": {
...
maintain a robust security posture for your GitLab CI/CD pipelines.
