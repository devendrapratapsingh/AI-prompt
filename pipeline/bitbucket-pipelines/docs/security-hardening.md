# Bitbucket Pipelines - Security Hardening Guide
...
Security hardening for Bitbucket Pipelines involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "Bitbucket Pipelines Builder"
          },
          "buildType": "Bitbucket Pipelines Pipeline",
          "invocation": {
            "configSource": {
              ...
              "entryPoint": "bitbucket-pipelines.yml"
            }
          },
          "metadata": {
...
maintain a robust security posture for your Bitbucket Pipelines pipelines.

For additional security resources and updates, refer to:
- Bitbucket Pipelines Security Documentation
