# Travis CI - Security Hardening Guide
...
Security hardening for Travis CI involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "Travis CI Builder"
          },
          "buildType": "Travis CI Pipeline",
          "invocation": {
            "configSource": {
...
maintain a robust security posture for your Travis CI pipelines.

For additional security resources and updates, refer to:
- Travis CI Security Documentation
