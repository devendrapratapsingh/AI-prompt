# Harness - Security Hardening Guide
...
Security hardening for Harness involves implementing multiple layers of security controls
        ...
        "predicate": {
          ...
          "invocation": {
            "configSource": {
              ...
              "entryPoint": "harness-pipeline.yaml"
            }
          },
          "metadata": {
...
maintain a robust security posture for your Harness pipelines.

For additional security resources and updates, refer to:
- Harness Security Documentation
