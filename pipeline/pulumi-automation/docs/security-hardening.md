# Pulumi Automation - Security Hardening Guide
...
Security hardening for Pulumi Automation involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "Pulumi Automation Builder"
          },
          "buildType": "Pulumi Automation Pipeline",
          "invocation": {
            "configSource": {
...
maintain a robust security posture for your Pulumi Automation pipelines.

For additional security resources and updates, refer to:
- Pulumi Automation Security Documentation
