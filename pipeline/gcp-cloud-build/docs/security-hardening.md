# GCP Cloud Build - Security Hardening Guide
...
Security hardening for GCP Cloud Build involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "GCP Cloud Build Builder"
          },
          "buildType": "GCP Cloud Build Pipeline",
          "invocation": {
            "configSource": {
...
maintain a robust security posture for your GCP Cloud Build pipelines.

For additional security resources and updates, refer to:
- GCP Cloud Build Security Documentation
