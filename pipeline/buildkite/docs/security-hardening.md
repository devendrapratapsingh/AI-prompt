# Buildkite - Security Hardening Guide
...
Security hardening for Buildkite involves implementing multiple layers of security controls
  ...
  script:
    ...
    - |
      cat > provenance.json << EOF
      {
        ...
        "predicate": {
          "builder": {
            "id": "Buildkite Builder"
          },
          "buildType": "Buildkite Pipeline",
          "invocation": {
            "configSource": {
              ...
              "entryPoint": ".buildkite/pipeline.yml"
            }
          },
          "metadata": {
...
maintain a robust security posture for your Buildkite pipelines.
